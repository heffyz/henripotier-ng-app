...
export class OfferComponent implements OnInit {
  ...
  constructor(private importBooks: ImportBooksService) {  this.importBooks.getOffer1().subscribe((o)=>{
    this.o=o;
  });
...
this.detailsValue='Plus';
  ...
  offreEnFr(o){
    if(o=='percentage'){return "pourcentage"}
    if(o=='minus'){return "bon"}
    if(o=='slice'){return "tranche"}
  }
  detailValuechange(){
